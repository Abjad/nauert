...
def test_QEventSequence_from_tempo_scaled_leaves_01():
    ...
    abjad.tie(staff[3:5])
    abjad.tie(staff[5:7])
    tempo = abjad.MetronomeMark(abjad.ValueDuration(1, 4), 55)
...
def test_QEventSequence_from_tempo_scaled_leaves_02():
    ...
    abjad.tie(staff[3:5])
    abjad.tie(staff[5:7])
    tempo = abjad.MetronomeMark(abjad.ValueDuration(1, 4), 58)
    abjad.attach(tempo, staff[0], context="Staff")
    tempo = abjad.MetronomeMark(abjad.ValueDuration(1, 4), 77)
