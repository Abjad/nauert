...
class UnweightedSearchTree(SearchTree):
    ...
    ..  container:: example
        ...
        >>> q_event_a = nauert.PitchedQEvent(abjad.mvo(130), [0, 1, 4])
        >>> q_event_b = nauert.PitchedQEvent(abjad.mvo(150), [2, 3, 5])
        >>> proxy_a = nauert.QEventProxy(q_event_a, abjad.mvo(0.5))
        >>> proxy_b = nauert.QEventProxy(q_event_b, abjad.mvo(0.667))
        >>> q_grid = nauert.QGrid()
